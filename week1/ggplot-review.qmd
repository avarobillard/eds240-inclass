...
ggplot(data = penguins,
  ...
  geom_point() +
  scale_color_manual(values = c("magenta", "purple", "cyan4"))
```
...
ggplot() +
  geom_point(data = penguins, mapping = aes(x=bill_length_mm,
                                            ...
                                            color=species),
             alpha = 0.5) +
  geom_point(data = penguins_summary, aes(x=mean_bill_length_mm,
...
ggplot(penguins, aes(x=flipper_length_mm, fill=species)) +
  ...
  scale_fill_manual(values = c("magenta", "purple", "cyan4")) +
...
p1+(p2/p3) +
  plot_annotation(title = "Penguin info")
```
